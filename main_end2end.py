...
print("STEP 2: normalize face as input to audio branch", flush=True)
shape_3d, scale, shift = util.norm_input_face(shape_3d)


print("STEP 3: Generate audio data as input to audio branch", flush=True)
# audio real data
au_data = []
au_emb = []
...
print("STEP 4: RUN audio->landmark network", flush=True)
...
print("STEP 5: de-normalize the output to the original image scale", flush=True)
...
os.remove(os.path.join('examples',ains[0]))
os.remove(os.path.join('examples',ains[0].replace('.wav', '_av.mp4')))
